...
## Introduction:
Smoking remains an important public-health issue, and population-level statistics can help decision-makers understand how smoking patterns change over time and whether progress is shared equally across population groups.

This project present a analysis of adult smoking prevalence in England between 2012 and 2019, with particular attention to differences across ethnic groups. The findings are considered from a public-health perspective, particularly how disaggregated data can support the identification of groups that may warrant further investigation when planning prevention and smoking-cessation strategies.

Leveraging the historical data and Microsoft Excel, I performed Excel data exploratory analysis to identify trends and disparities.

The analysis focuses on three areas:

- How adult smoking prevalence changed over time.
...
### Overall Smoking prevalence Trend
The prevalence in adult smoking in England started with a population percentage of 19.32% in 2012, and decreased to 13.88% in 2019, representing a 5.44 percentage-point reduction.
...
You can interact with the live visualization [here](https://1drv.ms/x/c/53d9d506ebaa43cf/IQBZkeC4eNy5RKIMN6Kp8JFXAWPaR9yCbGtnYGe3sbwCAy8?e=X6nf8L)

## Conclusion and Recommendation:
The analysis demonstrate why disaggregated analysis is important in public-health planning. A national decline in smoking prevalence is encouraging, but the data shows that progress has not resulted in identical prevalence levels across ethnic groups. 
...
### Key Recommendations:
1. Groups with comparatively high smoking prevalence should be investigated further to understand the factors contributing to the observed differences.
2. There should be usage of disaggregated data when planning interventions so that patterns that would otherwise be hidden get reveal.
3. Future analysis could combine smoking prevalence with additional variables such as Age, sex, socioeconomic status, geographic location and others. This will provide a stronger basis to understand why disparities exist and where interventions may be most appropriate.
4. There should be continuity of smoking prevention and cessation efforts since there is a demonstration of progress from the overall.

## Connect with me on Socials
[Github](https://github.com/Toyyibahh) | [LinkdeIn](http://www.linkedin.com/in/toyeebat-saadu)
